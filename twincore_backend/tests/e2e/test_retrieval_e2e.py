...
class TestRetrievalE2E:
    ...
    @pytest.mark.asyncio
    async def test_context_retrieval_e2e(self, seed_test_data, async_client):
    ...
    @pytest.mark.asyncio
    async def test_private_memory_retrieval_e2e(self, seed_private_test_data, async_client):
    ...
    @pytest.mark.asyncio
    async def test_query_ingestion_in_private_memory_e2e(self, seed_private_test_data, async_client):
